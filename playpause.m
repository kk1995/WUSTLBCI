...
% --- Executes just before playpause is made visible.
...
% UIWAIT makes playpause wait for user response (see UIRESUME)
...
% eventdata  reserved - to be defined in a future version of MATLAB
% hendandles    structure with handles and user data (see GUIDATA)
